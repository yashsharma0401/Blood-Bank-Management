...
<div class="container">
    <div class="row">
        <div class="col-md-10">
            <a href="#" id="Heading">Who we Are?</a>
            <p id="About">
                NITK Blood Bank Management System is a browser based system that is designed to store, process, retrieve and analyze information concerned with the administrative and inventory management within a blood bank. This  aims at maintaining all the information pertaining to blood donors, different blood groups available in each blood bank and help them manage in a better way. Aim is to provide transparency in this field, make the process of obtaining blood from a blood bank hassle free and corruption free and make the system of blood bank management effective.
            </p>
            <hr id="line_1">
...
- Camp Wise Donor List and Printing of Donor Cards.<br>
        ...
        <div class="col-md-2">
           <img src="images/blood_b.jpeg" class="img img-responsive img-thumbnail" style="width:200px ;">
        </div>
    </div>
</div>
