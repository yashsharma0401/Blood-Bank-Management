...
if (isset($_POST['searchBtn'])) {
    ...
    $donors = $db->Find_donor_by_blood($bloodGroup);
}
//Search By City
if (isset($_POST['searchByCityBtn'])) {
    $city = $_POST['city'];
    $donors = $db->Find_donor_by_city($city);
}
$title = "Home";
            ...
            <div class="form-group col-md-12">
                <form class="form-horizontal" method="post" action="home.php">
                    <div class="form-group">
                        <label class="col-sm-6">Find the donor by blood group </label>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-2">
                            <button class="btn btn-info btn-sm" name="searchBtn" >Find</button>
                        </div>
                    </div>
                ...
                <form class="form-horizontal" method="post" action="home.php">
                    <div class="form-group">
                        <label class="col-sm-6">Find donor by city </label>
                        <div class="col-sm-4">
                            <input type="text" name="city" value="" required="true" class="form-control"/>
                        </div>
                        <div class="col-sm-2">
                            <button class="btn btn-info btn-sm" name="searchByCityBtn" >Find</button>
                        </div>
                    </div>
