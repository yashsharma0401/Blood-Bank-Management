...
$db = new DBConnect();
$db->authenticateLogin(); // if user has logged in already then forward it to home.php
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="col-md-6">
                    <img src="images/security-icon.png" class="img img-responsive img-thumbnail">
                </div>
                <h5> User Login </h5>
            </div>
            <div class="panel-body">
                <form class="form-vertical" role="form" method="post" action="index.php">
                    ...
                    <div class="form-group loginBtn">
                        ...
                        <a href="users/" class="btn btn-sm btn-warning">New User</a>
			<a href="admin/" class="btn btn-sm btn-warning">Admin Login</a>
                    </div>
                </form>
            </div>
			</div>
    ...
    <div class="col-md-4">
        <img src="images/left-index-logo.jpg" class="img img-responsive">
    </div>
</div>
