...
if(isset($_POST['submitBtn'])){
    ...
    $db = new DBConnect();
    $flag = $db->addnewdonor($fname, $mname, $lname, $sex, $bType, $dob, $address, $city, $donationDate, $stats, $temp,
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <button class="btn btn-success" type="submit" name="submitBtn" >Confirm and ADD</button>
                            </div>
                        </div>
                    </div>
                </div>
