...
class DBConnect {
    ...
    public function addnewdonor($fname,$mname,$lname,$sex,$bType,$dob,$hAddress,$city,$donationDate,$stats,$temp,
    ...
    public function Find_donor_by_blood($bloodGroup){
        $stmt = $this->db->prepare("SELECT * FROM donors WHERE b_type = ?");
        $stmt->execute([$bloodGroup]);
        return $stmt->fetchAll();
    }
    
    public function Find_donor_by_city($city){
